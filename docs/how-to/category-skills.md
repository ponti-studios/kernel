...
This document provides a comprehensive guide to the **Category** and **Skill** systems, which form the extensibility core of Ghostwire.
...
## 6. Configuration Guide (ghostwire.json)

You can fine-tune categories in `ghostwire.json`.
