...
src/execution/builtin-skills/ralph-loop/  # Skill documentation
dist/orchestration/hooks/ralph-loop/         # Build output
dist/src/execution/builtin-skills/ralph-loop/  # Build output
```

### Boulder-related directories:

```
src/execution/boulder-state/        # State management for active plans
dist/execution/boulder-state/       # Build output
```
...
**`src/execution/builtin-commands/templates/ralph-loop.ts`**
...
**`src/execution/builtin-commands/commands.ts`**
...
**`src/execution/builtin-commands/templates/stop-continuation.ts`**

- Template text: "Cancel any active Ralph Loop"

**`src/execution/builtin-commands/templates/stop-continuation.test.ts`**
...
**`src/execution/builtin-skills/skills.ts`**

- Array entry: `"ralph-loop"`

**`src/execution/builtin-skills/ralph-loop/SKILL.md`**
...
- Migration: `ralph-loop` → `src/execution/builtin-skills/ralph-loop/`
...
- Task T048: Move `src/plugin/skills/ralph-loop/` to `src/execution/builtin-skills/ralph-loop/`
...
**`src/execution/boulder-state/types.ts`** (Type definitions)

- Interface: `BoulderState`
- Comment: "Named after the operator boulder—the eternal task that must be rolled."

**`src/execution/boulder-state/constants.ts`**
...
**`src/execution/boulder-state/storage.ts`** (Storage functions)
...
**`src/execution/boulder-state/storage.test.ts`** (Comprehensive tests - 100+ occurrences)
...
**`src/execution/builtin-commands/templates/start-work.ts`**
...
- Path: `src/execution/boulder-state`
...
| Type                | Count | Examples                                                                                   |
| ------------------- | ----- | ------------------------------------------------------------------------------------------ |
| Ralph directories   | 3     | `src/orchestration/hooks/ralph-loop/`, `src/execution/builtin-skills/ralph-loop/` |
| Boulder directories | 1     | `src/execution/boulder-state/`                                                    |
...
8. `src/execution/builtin-commands/templates/ralph-loop.ts`
9. `src/execution/builtin-commands/commands.ts`
10. `src/execution/builtin-commands/templates/stop-continuation.ts`
11. `src/execution/builtin-commands/templates/stop-continuation.test.ts`
12. `src/execution/builtin-skills/skills.ts`
13. `src/execution/builtin-skills/ralph-loop/SKILL.md`
...
1. `src/index.ts`
2. `src/execution/boulder-state/types.ts`
3. `src/execution/boulder-state/constants.ts`
4. `src/execution/boulder-state/storage.ts`
5. `src/execution/boulder-state/storage.test.ts`
...
10. `src/execution/builtin-commands/templates/start-work.ts`
11. `src/execution/builtin-commands/templates/stop-continuation.ts`
12. `src/execution/builtin-commands/templates/stop-continuation.test.ts`
13. `src/execution/builtin-commands/commands.ts`
