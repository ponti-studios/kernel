...
| File                                                        | Line | Context                                | Action Required                                         |
| ----------------------------------------------------------- | ---- | -------------------------------------- | ------------------------------------------------------- |
| `src/execution/builtin-skills/ralph-loop/SKILL.md` | 1    | `name: ralph-loop`                     | Replace with `ultrawork-loop`                           |
| `src/execution/builtin-skills/ralph-loop/SKILL.md` | 5    | `# Ralph Loop Skill`                   | Replace with `# Ultrawork Loop Skill`                   |
| `src/execution/builtin-skills/ralph-loop/SKILL.md` | 6    | `ralph-loop is a small...`             | Replace with `ultrawork-loop is a small...`             |
| `src/execution/builtin-skills/ralph-loop/SKILL.md` | 8    | "Keep ralph-loop narrow..."            | Replace with "Keep ultrawork-loop narrow..."            |
| `src/execution/builtin-skills/ralph-loop/SKILL.md` | 10   | "agents/ralph-loop.md"                 | Replace with "agents/ultrawork-loop.md"                 |
| `src/execution/builtin-skills/ralph-loop/SKILL.md` | 11   | "skills/ralph-loop/SKILL.md"           | Replace with "skills/ultrawork-loop/SKILL.md"           |
| `src/execution/builtin-skills/ralph-loop/SKILL.md` | 12   | "Start ralph-loop"                     | Replace with "Start ultrawork-loop"                     |
| `src/execution/builtin-skills/ralph-loop/SKILL.md` | 13   | "ralph-loop is intentionally small..." | Replace with "ultrawork-loop is intentionally small..." |
...
| File                                                | Line | Context                            | Action Required                                  |
| --------------------------------------------------- | ---- | ---------------------------------- | ------------------------------------------------ |
| `src/execution/boulder-state/types.ts`     | 5    | "Named after the operator boulder" | Replace with Ultrawork metaphor                  |
| `src/execution/boulder-state/constants.ts` | -    | `BOULDER_DIR = ".operator"`        | Keep (directory name)                            |
| `src/execution/boulder-state/constants.ts` | -    | `BOULDER_FILE = "boulder.json"`    | Replace with `ULTRAWORK_FILE = "ultrawork.json"` |
| `src/execution/boulder-state/constants.ts` | -    | `BOULDER_STATE_PATH`               | Replace with `ULTRAWORK_STATE_PATH`              |
| `src/execution/boulder-state/storage.ts`   | -    | `getBoulderFilePath()`             | Rename to `getUltraworkFilePath()`               |
| `src/execution/boulder-state/storage.ts`   | -    | `readBoulderState()`               | Rename to `readUltraworkState()`                 |
| `src/execution/boulder-state/storage.ts`   | -    | `writeBoulderState()`              | Rename to `writeUltraworkState()`                |
| `src/execution/boulder-state/storage.ts`   | -    | `clearBoulderState()`              | Rename to `clearUltraworkState()`                |
| `src/execution/boulder-state/storage.ts`   | -    | `createBoulderState()`             | Rename to `createUltraworkState()`               |
| `src/execution/boulder-state/types.ts`     | -    | `BoulderState` interface           | Rename to `UltraworkState`                       |
...
| File                                                                     | Line | Context                    | Action Required                       |
| ------------------------------------------------------------------------ | ---- | -------------------------- | ------------------------------------- |
| `src/execution/builtin-commands/templates/ralph-loop.ts`        | -    | `RALPH_LOOP_TEMPLATE`      | Rename to `ULTRAWORK_LOOP_TEMPLATE`   |
| `src/execution/builtin-commands/templates/ralph-loop.ts`        | -    | `CANCEL_RALPH_TEMPLATE`    | Rename to `CANCEL_ULTRAWORK_TEMPLATE` |
| `src/execution/builtin-commands/templates/ralph-loop.ts`        | -    | "Ralph Loop" references    | Replace with "Ultrawork Loop"         |
| `src/execution/builtin-commands/templates/start-work.ts`        | -    | "boulder state" references | Replace with "ultrawork state"        |
| `src/execution/builtin-commands/templates/stop-continuation.ts` | -    | "Ralph Loop" references    | Replace with "Ultrawork Loop"         |
| `src/execution/builtin-commands/commands.ts`                    | -    | Template imports           | Update imports                        |

### 2.7 Skills Registry

| File                                              | Line | Context                   | Action Required                 |
| ------------------------------------------------- | ---- | ------------------------- | ------------------------------- |
| `src/execution/builtin-skills/skills.ts` | -    | `"ralph-loop"` skill name | Replace with `"ultrawork-loop"` |
