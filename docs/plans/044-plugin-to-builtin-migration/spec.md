...
- **Commands exist in two places**: `src/plugin/commands/*.md` (21 files) AND `src/execution/builtin-commands/templates/*.ts`
- **Skills exist in two places**: `src/plugin/skills/*/` (14 skills) AND `src/execution/builtin-skills/*/` (5 skills already migrated)

This dual system creates maintenance burden and unclear ownership.

## Goals

1. **Migrate 21 plugin commands** to TypeScript templates in `src/execution/builtin-commands/templates/`
2. **Migrate 14 plugin skills** to `src/execution/builtin-skills/`
...
1. `andrew-kane-gem-writer` → `src/execution/builtin-skills/andrew-kane-gem-writer/`
2. `brainstorming` → `src/execution/builtin-skills/brainstorming/`
...
10. `frontend-design` → `src/execution/builtin-skills/frontend-design/`
11. `gemini-imagegen` → `src/execution/builtin-skills/gemini-imagegen/`
12. `git-worktree` → `src/execution/builtin-skills/git-worktree/`
13. `ralph-loop` → `src/execution/builtin-skills/ralph-loop/`
14. `rclone` → `src/execution/builtin-skills/rclone/`
15. `skill-creator` → `src/execution/builtin-skills/skill-creator/`
...
- `src/plugin/skills/file-todos/` → `src/execution/builtin-skills/file-todos/`
...
- `src/execution/builtin-commands/commands.ts` - Command registry
- `src/execution/builtin-commands/templates/` - Template location
- `src/execution/builtin-skills/skills.ts` - Skill registry
- `src/execution/builtin-skills/` - Skill location
