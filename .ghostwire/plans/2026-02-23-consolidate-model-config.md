...
- [x] **TODO-3.1**: Remove DEFAULT_MODELS_CONFIG import
...
- [x] **TODO-3.4**: Rewrite writeModelConfig() function
  - **File:** `src/cli/config-manager.ts`
  - **Lines:** 739-783
...
- [x] No `models` section in GhostwireConfigSchema
- [x] No model-config.ts or model-config-resolver.ts files
- [x] writeModelConfig() writes to agents/categories
