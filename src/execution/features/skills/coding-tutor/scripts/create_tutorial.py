...
def create_tutorial(topic, concepts=None, output_dir=None):
    ...
    Args:
        ...
        output_dir: Directory to save tutorial (defaults to ~/ghostwire-tutorials/)
...
NOTE: Update the frontmatter 'prerequisites' field with up to 3 relevant past tutorials if this builds on previous concepts (e.g., [ghostwire-tutorials/2025-11-20-basics.md]). Leave as empty array [] if this is foundational.]
...
def main():
    ...
    parser.add_argument(
        "--output-dir",
        help="Output directory for tutorial (defaults to ~/ghostwire-tutorials/)",
        default=None
    )
