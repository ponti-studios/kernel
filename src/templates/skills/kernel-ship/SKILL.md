---
name: kernel-ship
description: "Validate production readiness, confirm with the user, then deploy with the correct strategy for the change. Use when deploying services, releasing a feature, coordinating database migrations, managing mobile builds, or diagnosing a deployment failure."
argument-hint: "Branch, PR, feature, or issue to ship"
---
