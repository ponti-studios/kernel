...
profile: extended
description: >-
  Creates, audits, and improves kernel skills against established quality
  standards. Use when creating a new skill, auditing existing skills for
...
termination:
  ...
  - New skill has a passing description, correct body structure, and
    appropriate behavioral fields set
outputs:
