...
import { getSkillInstructions, getSkillReferences } from "../../.generated/templates';

export function getKernelDesignSkillTemplate(): SkillTemplate {
  return {
    name: "kernel-design",
    description:
    ...
    instructions: getSkillInstructions("kernel-design"),
  };
}
