...
profile: extended
description: >-
  Enforces the project design system when designing, writing, reviewing, or
  modifying any frontend UI code - tokens, animations, accessibility,
  responsive layout, performance, and chat UI. Use when building UI
  components, styling views, reviewing frontend code for design compliance, or
  when users ask about design system rules. This skill is prescriptive,
  standards-heavy, and does not support Next.js.
license: MIT
compatibility: >-
  Supported frontend stack: React web and React Native. Next.js is not
  supported.
metadata:
  author: project
  version: "2.1"
