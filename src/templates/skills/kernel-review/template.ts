...
export function getKernelReviewSkillTemplate(): SkillTemplate {
  return {
    name: "kernel-review",
    description:
    ...
    when: [
      ...
      "after kernel-apply completes a set of sub-issues",
    ],
    applicability: [
    ...
    dependencies: [],
    instructions: getSkillInstructions("kernel-review"),
  };
}
