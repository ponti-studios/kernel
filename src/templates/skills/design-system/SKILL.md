...
- `references/design-system-foundations.md` — tokens, typography, color, spacing, elevation, radii, grid, z-index, accessibility
- `references/design-system-motion.md` — GSAP mandate, canonical sequences, timing, easing, reduced motion, mobile animation
- `references/design-system-components.md` — button, input, card, sheet, badge, avatar, skeleton, toast, empty state, link, form, table, code block, markdown
- `references/design-system-patterns.md` — responsive behaviour, overlay stacking, focus management, copy/writing style, image handling, gesture thresholds, route transitions, scrollbars, cursor rules, selection styles
- `references/design-system-chat.md` — chat UI: header, message bubbles, transcript, composer, thinking indicator, shimmer, animations, tokens, common violations
...
These rules apply to all chat UI components: web and mobile. Always consult `references/design-system-chat.md` for the full specification.
