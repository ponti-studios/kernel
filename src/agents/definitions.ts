...
export const AGENT_DEFINITIONS: AgentProfileSpec[] = [
  // Planning & Strategy (3)
  {
    ...
    route: 'do',
    tools: ['read', 'search'],
    acceptanceChecks: ['Problem analysis is thorough', 'Solutions are well-reasoned', 'Edge cases identified'],
  ...
  {
    id: 'planner',
    intent: 'Strategic planning consultant that interviews users and produces comprehensive work plans',
    role: 'Planning',
    route: 'do',
  ...
  // Architecture & Design (7)
  {
    ...
    acceptanceChecks: ['Architecture review is comprehensive', 'Agent-native patterns identified', 'Recommendations are specific'],
  ...
  },
  {
    ...
    acceptanceChecks: ['Design compliance verified', 'Discrepancies documented', 'Recommendations provided'],
  ...
  {
    id: 'designer-sync',
    intent: 'Synchronize web implementation with Figma design by detecting and fixing visual differences',
    role: 'Design',
    route: 'do',
...
export function lookupAgentById(catalog: AgentCatalog, agentId: string): AgentProfileSpec | undefined {
