...
All notable changes to the ghostwire plugin will be documented in this file.
...
- **Coding tutor merge** - Consolidated coding tutor plugin content into ghostwire plugin
  - Added commands: `/ghostwire:teach-me`, `/ghostwire:quiz-me`, `/ghostwire:sync-tutorials`
  - Added skill: `coding-tutor` with integrated tutorial scripts

### Changed

- **Tutorial storage path** - Renamed tutor data path to `~/ghostwire-tutorials/`
- **No auto-migration policy** - Legacy `~/coding-tutor-tutorials/` data is left untouched
- **Plugin metadata** - Updated plugin counts to 29 agents, 27 commands, 17 skills

### Removed

- **Standalone coding-tutor plugin directory** - Deleted `src/plugins/coding-tutor` after consolidation

### Summary

- 29 agents, 27 commands, 17 skills, 1 MCP server
...
- [#102](https://github.com/EveryInc/ghostwire/pull/102) feat(research): add mandatory API deprecation validation
- [#101](https://github.com/EveryInc/ghostwire/pull/101) feat: Add /workflows:brainstorm command and skill
- [#100](https://github.com/EveryInc/ghostwire/pull/100) feat(workflows:plan): Add smart research decision logic
...
- **`/lfg` command** - Full autonomous engineering workflow
  ...
  - Uses overclock-loop for autonomous completion
