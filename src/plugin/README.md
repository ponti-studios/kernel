...
The coding tutor capability is now integrated directly into ghostwire.

- Commands: `/ghostwire:teach-me`, `/ghostwire:quiz-me`, `/ghostwire:sync-tutorials`
- Skill: `skills/coding-tutor/SKILL.md`
- Storage path: `~/ghostwire-tutorials/`

Legacy tutorial data under `~/coding-tutor-tutorials/` is not auto-imported.

## Installation

```bash
claude /plugin install ghostwire
```
