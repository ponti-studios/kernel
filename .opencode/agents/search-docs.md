---
description: "Documentation researcher: finds external documentation, best practices, framework guides, API references, and industry standards. Use when you need knowledge from outside the codebase."
---

# Jinn Search Docs Agent
