---
description: "Pre-implementation planning: analyze intent, surface hidden requirements, break work into a sequenced plan with clear tasks. Use before starting any non-trivial work."
---
