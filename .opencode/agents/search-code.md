---
description: "Codebase searcher: finds files, functions, classes, and patterns in the local repository. Use when you need to locate specific code or understand the structure of a codebase."
---

# Jinn Search Code Agent
