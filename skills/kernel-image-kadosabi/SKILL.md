...
when:
  ...
  - user invokes /kernel-image-kadosabi
outputs:
...
**Non-negotiable:** This skill generates rubber-hose future-world content exclusively. If the user asks for a 3D render or toy-like character model, redirect to `kernel-image-3d`. Lucy is an ink character — do not render her in 3D.
