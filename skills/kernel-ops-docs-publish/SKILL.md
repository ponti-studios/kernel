...
It does not replace the craft work used to make the artifacts. Draft the script and production plan with your preferred writing workflow. Use the appropriate slides/deck workflow when slides are required.
...
3. If the video script or production plan does not exist, draft it before assembling the package.
