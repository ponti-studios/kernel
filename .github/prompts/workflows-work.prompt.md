...
3. **Create Pull Request**
   ...
   [![Compound Engineered](https://img.shields.io/badge/Compound-Engineered-6366f1)](https://github.com/EveryInc/ghostwire) 🤖 Generated with [Claude Code](https://claude.com/claude-code)
   EOF
   )"
   \`\`\`
